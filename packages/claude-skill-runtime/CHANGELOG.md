...
- 73f229a: Fix pre-tool guardrail matching, add opt-in user-scope rules, and accept current hook
  payload shapes.
...
- 86f2646: update exports and files configuration in package.json

## 1.0.0

### Major Changes

- 1f57049: release initial claude-skill-runtime
